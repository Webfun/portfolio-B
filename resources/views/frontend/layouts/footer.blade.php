                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="widget footer-widget mrr-30 mrr-md-0">
                            ...
                            <address class="mrb-0">
                                ...
                                <div class="mrb-10">
                                    <a href="#"><i class="fas fa-phone-alt mrr-10"></i>+1234567890</a>
                                </div>
                                <div class="mrb-10">
                                    <a href="#"><i class="fas fa-envelope mrr-10"></i>Sales@alyasmeenkw.com</a>
                                </div>
                                <div class="mrb-0">
                                    <a href="#"><i class="fas fa-globe mrr-10"></i>www.aliasmeen.com</a>
                                </div>
                            </address>
                        </div>
                    </div>
